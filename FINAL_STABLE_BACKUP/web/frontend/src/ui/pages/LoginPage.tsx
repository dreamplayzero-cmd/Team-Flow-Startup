                    ...
                    <div className="md:col-span-5 bg-white/30 backdrop-blur-xl p-10 md:p-14 lg:p-20 flex flex-col justify-center border-t md:border-t-0 md:border-l border-white/20">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <button 
                                    onClick={onLogin}
                                    className="w-full flex items-center justify-center gap-3 py-4 rounded-xl bg-white border border-stitch-outline-variant/20 text-stitch-on-surface font-st-headline font-bold text-sm transition-all hover:bg-stitch-background active:scale-[0.98] shadow-sm"
                                >
                                ...
                                <button 
                                    className="w-full flex items-center justify-center gap-3 py-4 rounded-xl bg-[#FEE500] text-black font-st-headline font-bold text-sm transition-all hover:brightness-95 active:scale-[0.98] shadow-sm"
                                >
                            ...
                            <button 
                                onClick={onLogin}
                                className="w-full mt-6 py-4 rounded-xl border border-stitch-primary/30 text-stitch-primary font-black text-xs uppercase tracking-[0.2em] hover:bg-stitch-primary/5 transition-all"
                            >
                                신규 창업자 회원가입
                            </button>
                        </form>
                        ...
                        <div className="text-center mt-10">
                            <p className="text-[10px] text-stitch-on-surface-variant/40 leading-relaxed font-bold uppercase tracking-widest">Authorized Personnel Only <br />StarterMap Security Protocol Layer 7</p>
                        </div>
                    </div>
                </motion.div>
