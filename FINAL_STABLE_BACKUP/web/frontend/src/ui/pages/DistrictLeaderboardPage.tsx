        ...
        <div className="bg-stitch-background text-stitch-on-surface min-h-screen flex selection:bg-stitch-primary/10 font-body">
            ...
            <aside className="fixed top-0 left-0 h-full w-64 bg-stitch-surface border-r border-stitch-outline-variant/30 z-[60] hidden lg:flex flex-col">
                <div className="p-8 flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="font-st-headline font-extrabold text-stitch-primary text-sm leading-tight">Youth Startup Flow</h2>
            ...
            <div className="flex-1 lg:pl-64 transition-all w-full">
                ...
                <main className="pt-28 pb-24 px-10 md:px-16 max-w-7xl mx-auto">
                    ...
                    {/* Rank Cards Section */}
                    <section className={`grid grid-cols-1 md:grid-cols-2 ${sortedResults.length > 3 ? 'lg:grid-cols-4' : 'lg:grid-cols-3'} gap-6 mb-20`}>
                        {sortedResults.length > 0 && (
                            <motion.div
                            ...
                            >
                                ...
                                <div className="mb-12 z-10">
                                    <div className="text-7xl font-st-headline font-black mb-2 tracking-tighter flex items-end gap-2 drop-shadow-[0_0_20px_rgba(78,222,163,0.3)]">
                        ...
                        {sortedResults.slice(1).map((item, idx) => (
                            <motion.div
                                key={item.id}
                                whileHover={{ y: -10 }}
                                onClick={onShowReport}
                            ...
                            >
                                ...
                                <div className="mb-12 z-10">
                                    <div className="text-7xl font-st-headline font-black text-stitch-primary mb-2 tracking-tighter">{item.score}</div>
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="mt-16 pt-8 border-t border-stitch-outline-variant/10">
                                <p className="text-stitch-on-surface-variant/60 font-medium text-sm text-center">
                                    ...
                                    <strong className="text-stitch-primary font-black">창업자를 위한 심층 리포트가 준비되었습니다.</strong>
                                </p>
                            </div>
                        </div>
                    </section>
