...
class AudioRouteObserver extends NavigatorObserver {
  ...
  AudioRouteObserver(this.context);

  @override
  void didPush(Route<dynamic> route, Route<dynamic>? previousRoute) {
    super.didPush(route, previousRoute);
    // Removed advance() call to prevent crashes after rollback
  }
}
...
class AppRouter {
  ...
  static GoRouter createRouter(BuildContext context) => GoRouter(
    ...
    observers: [AudioRouteObserver(context)],
    routes: [
      // 1. 로그인 화면
      GoRoute(
        path: '/login',
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.map_rounded), label: '업종 밀집도'),
