...
class _DistrictReportPageState extends State<DistrictReportPage> {
  ...
  Widget _getDynamicImage(String type, SelectionProvider selection) {
    ...
    // [CSI FIX] Precise Industry Mapping for 4 Main Categories
    ...
    if (type == 'summary') {
      // [CSI RESTORE] District Aligned Store Interior
      if (district.contains('한남')) {
        imageUrl = 'https://images.unsplash.com/photo-1541604193435-22287d32c2c2?q=80&w=1000'; // High-end Hannam
      } else if (district.contains('이태원')) {
        imageUrl = 'https://images.unsplash.com/photo-1514933651103-005eec06c04b?q=80&w=1000'; // Global Itaewon
      } else if (district.contains('연남')) {
        imageUrl = 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?q=80&w=1000';
      } else {
        imageUrl = 'https://images.unsplash.com/photo-1559925373-2f8218b5f54c?q=80&w=1000'; // Seongsu
      }

      // Special override for Fashion/Edit Shop logic
      ...
      // [CSI TOP LOCKDOWN] UNIQUE FUTURE PREDICTION IMAGES
      ...
      // [CSI LOCKDOWN V2] type == 'clustering' (Page 9 Bottom: Industry Art Assets)
