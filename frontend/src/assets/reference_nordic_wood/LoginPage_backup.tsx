        ...
        <div className="bg-stitch-background text-stitch-on-surface min-h-screen w-full flex flex-col relative overflow-x-hidden font-body selection:bg-stitch-primary/10">
            ...
            <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
                <img
                    ...
                    alt="Nordic wood grain"
                    src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=2070"
                />
                <div className="absolute inset-0 bg-gradient-to-tr from-stitch-background/40 via-transparent to-stitch-primary/10"></div>
            </div>
            ...
            <main className="relative z-10 min-h-screen w-full flex flex-col items-center justify-center py-12 px-6 md:px-12 lg:px-16 xl:px-24">
                ...
                >
                    <span className="text-[13px] font-st-headline font-bold uppercase tracking-[0.4em] text-stitch-on-surface-variant mb-5 block">더 소버린 인사이트</span>
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tighter text-stitch-primary leading-none font-st-headline">창업자 포털</h1>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="w-full max-w-[1280px] grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-px bg-white/40 backdrop-blur-3xl rounded-[2.5rem] overflow-hidden shadow-[0_64px_128px_-32px_rgba(93,67,51,0.15)] border border-white/60"
                >
