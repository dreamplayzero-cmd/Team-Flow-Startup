  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('분석 모델 설정', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ),
      body: Column(
        children: [
          _buildProgressBar(),
          ...
          return Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: index <= _currentStep ? const Color(0xFF3B82F6) : Colors.white10,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('AI가 이 페르소나의 소비 패턴을 분석합니다.', style: TextStyle(color: Colors.white54, fontSize: 15)),
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    const Text('창업 예산', style: TextStyle(color: Colors.white70, fontSize: 16)),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: const [
                    Text('시드 (1천만)', style: TextStyle(color: Colors.white24, fontSize: 10)),
                    Text('스케일업 (5억)', style: TextStyle(color: Colors.white24, fontSize: 10)),
                    Text('확장 (10억)', style: TextStyle(color: Colors.white24, fontSize: 10)),
                  ],
                ),
              ],
            ),
  ...
  Widget _buildSelectionCard(IconData icon, String title, String desc, {required bool isSelected, required VoidCallback onTap}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        padding: const EdgeInsets.all(20),
        decoration: BoxDecoration(
          color: isSelected ? const Color(0xFF3B82F6).withValues(alpha: 0.1) : const Color(0xFF1E293B),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: isSelected ? const Color(0xFF3B82F6) : Colors.white.withValues(alpha: 0.05)),
        ),
        child: Row(
          children: [
            Icon(icon, color: isSelected ? const Color(0xFF3B82F6) : Colors.white54, size: 32),
            const SizedBox(width: 20),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(title, style: TextStyle(color: isSelected ? Colors.white : Colors.white70, fontWeight: FontWeight.bold, fontSize: 16)),
