...
class LeaderboardPage extends StatelessWidget {
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Container(
                ...
                child: Opacity(
                  opacity: 0.1,
                  child: Icon(Icons.leaderboard_rounded, size: 200, color: Colors.blueAccent.withOpacity(0.5)),
                ),
              ),
            ),
          ),
  ...
  Widget _buildFilterChip(String label, {bool isSelected = false}) {
    return Container(
      ...
      child: Text(
        label,
        style: TextStyle(color: isSelected ? Colors.white : Colors.white60, fontSize: 13, fontWeight: isSelected ? FontWeight.bold : FontWeight.normal),
      ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: isTopThree ? Colors.blueAccent.withOpacity(0.3) : Colors.white.withOpacity(0.05),
            width: isTopThree ? 1.5 : 1,
          ),
          boxShadow: isTopThree ? [BoxShadow(color: Colors.blueAccent.withOpacity(0.05), blurRadius: 10)] : null,
        ),
        child: Row(
          children: [
            // 순위 숫자
            Container(
              ...
              child: Text(
                '${index + 1}',
                style: TextStyle(
                  color: isTopThree ? Colors.blueAccent : Colors.white30,
                  fontSize: 22,
            ...
            Column(
              ...
              children: [
                Text(
                  '${scores[index]}',
                  style: const TextStyle(color: Color(0xFF3B82F6), fontSize: 20, fontWeight: FontWeight.bold),
                ),
