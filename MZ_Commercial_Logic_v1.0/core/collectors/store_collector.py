...
class StoreCollector:
    ...
    def _generate_fallback_data(self, adong_cd):
        ...
        self._save_to_db(fallback_items, adong_cd)
        return True

    def _save_to_db(self, rows, adong_cd):
        ...
        if processed_data:
            ...
            logger.info(f"Successfully saved {len(processed_data)} store records for {adong_cd}")
