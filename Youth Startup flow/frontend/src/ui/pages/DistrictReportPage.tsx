                        ...
                        >
                            <div className="h-48 bg-[url('https://images.unsplash.com/photo-1590487988256-9ed24133863e?q=80&w=1000')] bg-cover bg-center flex items-center px-16 relative">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-white/60 font-black text-[10px] uppercase tracking-[0.4em] ml-16">미래 상권 시뮬레이션 모델 v.2.0 (Location Intelligence)</p>
                                </div>
                            </div>
                            ...
                            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12">
                                ...
                                <div className="lg:col-span-8">
                                    <div className="aspect-video bg-black/40 rounded-[3rem] relative overflow-hidden border border-white/5 mb-8">
                                        ...
                                        <div className="absolute bottom-4 right-4 text-[7px] font-black text-white/10 uppercase tracking-widest pointer-events-none z-50">Source: 서울 상권 분석 / 업종 군집 분석 엔진 v2.0</div>
                                    </div>
