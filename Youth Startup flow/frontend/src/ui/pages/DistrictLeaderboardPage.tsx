...
export const DistrictLeaderboardPage: React.FC<DistrictLeaderboardPageProps> = ({ onBack, onShowReport }) => {
    ...
    // [CSI SPEED OPTIMIZATION] Preload heavy assets for instant report view
    React.useEffect(() => {
        const imagesToPreload = [
            seoulMap,
            'https://images.unsplash.com/photo-1590487988256-9ed24133863e?q=80&w=1000',
        ...
        console.log("CSI: Report assets pre-cached for MZ speed.");
    }, []);
