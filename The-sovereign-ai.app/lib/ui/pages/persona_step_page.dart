...
class _PersonaStepPageState extends State<PersonaStepPage> {
  ...
  void _nextStep() {
    ...
    if (_currentStep < 3) {
      _pageController.nextPage(duration: Duration(milliseconds: 500), curve: Curves.easeInOutCubic);
  ...
  Widget _buildSelectionCard(IconData icon, String title, String desc, {required bool isSelected, required VoidCallback onTap}) {
    ...
    ).animate().fadeIn(duration: Duration(milliseconds: 400)).slideX(begin: 0.1, end: 0);
  }
