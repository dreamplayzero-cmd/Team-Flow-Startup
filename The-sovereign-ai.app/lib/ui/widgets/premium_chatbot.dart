      ...
      child: Column(
        ...
        children: [
          if (!_isOpened)
            ...
            ).animate().fadeIn(delay: Duration(seconds: 1)).slideY(begin: 0.5, end: 0),
          ...
          Container(
           ...
           .scale(begin: const Offset(1.0, 1.0), end: const Offset(1.05, 1.05), duration: Duration(seconds: 2), curve: Curves.easeInOut),
        ],
      ),
    );
  }
  ...
  Widget _buildAiMessage(String text) {
    return Column(
      ...
      children: [
        ...
        ).animate().fadeIn(duration: Duration(milliseconds: 600)).slideY(begin: 0.1, end: 0),
